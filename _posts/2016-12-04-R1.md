...
Kommentelni github-accounttal itt lehet. Mélt is lehet írni.
 ...
 <script type="text/javascript">
   function loadComments(data) {
     for (var i=0; i<data.length; i++) {
       ...
       var clink = "https//labadigergely.github.io/szovegek/2016/12/04/R1/issues/2#issuecomment-" data[i].url.substring(data[i].url.lastIndexOf("/")+1);
