...
De ha magunk akarunk távoli olvasni, akkor érdemes belevetni magunkat az `R` használatába. Nekem Matthew Jockers könyve volt az útmutató. Az ő példáit alkalmazom, némi módosítással.
