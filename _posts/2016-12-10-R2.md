...
ustokos.l <- lapply(chapter.freqs.l, '[', 'üstökös')

arany.m = do.call(rbind, arany.l)
hold.m = do.call(rbind, hold.l)
ustokos.m = do.call(rbind, ustokos.l)
```
